...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 via-white to-blue-50 py-12 px-4">
      <Helmet><title>Register - AI Accountant</title></Helmet>
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 space-y-6 border border-gray-100">
          <form onSubmit={handleSubmit(signup)} className="space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input type="text" placeholder="John Doe" className={`block w-full pl-10 pr-3 py-3 border ${errors?.name && touchedFields?.name ? 'border-red-300 focus:ring-red-500' : 'border-gray-300 focus:ring-purple-500'} rounded-lg focus:outline-none focus:ring-2 transition-colors text-gray-900 placeholder-gray-400`} {...register("name")} />
              </div>
              {errors?.name && touchedFields?.name && <p className="mt-2 text-sm text-red-600 flex items-center"><svg className="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clipRule="evenodd" /></svg>{errors.name.message}</p>}
            </div>
            <div>
              ...
              <div className="relative">
                ...
                <input type="email" placeholder="you@example.com" className={`block w-full pl-10 pr-3 py-3 border ${errors?.email && touchedFields?.email ? 'border-red-300 focus:ring-red-500' : 'border-gray-300 focus:ring-purple-500'} rounded-lg focus:outline-none focus:ring-2 transition-colors text-gray-900 placeholder-gray-400`} {...register("email")} />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="password" placeholder="Create a password" className={`block w-full pl-10 pr-3 py-3 border ${errors?.password && touchedFields?.password ? 'border-red-300 focus:ring-red-500' : 'border-gray-300 focus:ring-purple-500'} rounded-lg focus:outline-none focus:ring-2 transition-colors text-gray-900 placeholder-gray-400`} {...register("password")} />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <select className={`block w-full pl-10 pr-3 py-3 border ${errors?.businessType && touchedFields?.businessType ? 'border-red-300 focus:ring-red-500' : 'border-gray-300 focus:ring-purple-500'} rounded-lg focus:outline-none focus:ring-2 transition-colors bg-white text-gray-900`} {...register("businessType")}>
              ...
              {errors?.businessType && touchedFields?.businessType && <p className="mt-2 text-sm text-red-600 flex items-center"><svg className="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clipRule="evenodd" /></svg>{errors.businessType.message}</p>}
            </div>
          ...
          <div className="text-center pt-4 border-t border-gray-200">
            <p className="text-sm text-gray-600">Already have an account? <a href="/login" className="font-medium text-purple-600 hover:text-purple-500 transition-colors">Sign in instead</a></p>
          </div>
        </div>
      </div>
    </div>
